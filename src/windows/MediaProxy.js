    ...
    */
    ...
    module.exports = {
        ...
        create:function(win, lose, args) {
            ...
            if (thisM.node === null) {
                ...
                if (createAudioNode === true) {
                    ...
                    thisM.node.onloadstart = function () {
                        thisM._status = Media.MEDIA_STARTING;
                    ...
                    thisM.node.onplaying = function () {
                        thisM._status = Media.MEDIA_RUNNING;
                    ...
                    thisM.node.onerror = function (e) {
                        thisM._status = Media.MEDIA_ERROR;
                    ...
                    thisM.node.onended = function () {
                        thisM._status = Media.MEDIA_STOPPED;
            ...
            if (win) {
                win((thisM._status === Media.MEDIA_RUNNING));
            }
        ...
        startPlayingAudio:function(win, lose, args) {
            ...
            var allMedia = Media.getAll();
            if (allMedia) {
                for (var name in allMedia) {
                    if (allMedia.hasOwnProperty(name)) {
                        if (name && allMedia[name]) {
                            if (allMedia[name].node) {
                                allMedia[name].node.pause();
                                allMedia[name].node.currentTime = 0;
                                allMedia[name]._status = Media.MEDIA_STOPPED;
                                Media.onStatus(allMedia[name].id, Media.MEDIA_STATE, Media.MEDIA_STOPPED);
                            }
                        }
                    }
                }
